...
namespace LPD.Compiler.Lexical
{
    ...
    public class InvalidTokenException : Exception
    {
        ...
        public InvalidTokenException(ProgramPosition position)
        {
            Position = position;
        }
        ...
        public InvalidTokenException(ProgramPosition position, string message)
            : base(message)
        {
            Position = position;
        }
        ...
        public InvalidTokenException(ProgramPosition position, string message, Exception innerException)
